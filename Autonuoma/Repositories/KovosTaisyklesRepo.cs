...
public class KovosTaisyklesRepo : RepoBase
{
    ...
    {
        var query = $@"SELECT * FROM `{Config.TblPrefix}Kovos_Taisykles` ORDER BY Taisykliu_pavadinimas ASC";
    ...
    {
        var query = $@"SELECT * FROM `{Config.TblPrefix}Kovos_Taisykles` WHERE Taisykliu_pavadinimas=?pk";
    ...
    public static void Insert(KovosTaisykles k)
    {
        var query = $@"INSERT INTO `{Config.TblPrefix}Kovos_Taisykles`
		               (Taisykliu_pavadinimas, Raundu_Skaicius, Raundo_Trukme_min, Kovos_Taisykles, Tasku_sistema)
    ...
    public static void Update(string originalPK, KovosTaisykles k)
    {
        var query = $@"UPDATE `{Config.TblPrefix}Kovos_Taisykles`
		               SET Taisykliu_pavadinimas=?pav, Raundu_Skaicius=?rs, Raundo_Trukme_min=?rt,
		                   Kovos_Taisykles=?kt, Tasku_sistema=?ts
